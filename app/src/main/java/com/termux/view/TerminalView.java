    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                // "Raw keyboard input": upstream Termux behaviour. Keyboards treat this like a
                // password field, which disables suggestions/autocorrect but also voice typing.
                // https://github.com/termux/termux-app/issues/686
                outAttrs.inputType = InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS;
            } else {
                // Pocket-CLI default: a real text field with suggestions and auto-correct turned
                // off. Unlike TYPE_NULL or the password variation above, this keeps keyboard voice
                // typing (Gboard, Samsung, Sogou, Baidu...) enabled; dictated words arrive through
                // commitText()/finishComposingText() below.
